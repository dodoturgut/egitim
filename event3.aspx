<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="event3.aspx.cs" Inherits="event3" %>
                        ...
                        <div class="wizard-forms position-relative">
                            ...
                            <div class="wizard-inner-box">
                                <div class="inner-title text-center">
                                    <p>
                                       Birazdan sana bazı kelimeler göstereceğim. Bakalım bu kelimeleri görünce aklına gelen ilk kelimeyi yazabilecek misin?
                                    </p>
                        ...
                        <div class="wizard-forms form-step-2">
                            ...
                            <div class="wizard-inner-box">
                                <div class="inner-title text-center">
                                    ...
                                    <br />
                                    <br />
                                    <h3>Bakalım bu kelimeleri görünce aklına gelen ilk kelimeyi yazabilecek misin?</h3>
                                </div>
                            </div>
