                ...
                <div class="center">
                    ...
                    <div class="login">
                        <label>
                            ...
                            <asp:TextBox runat="server" ID="txtPhone" class="username" type="phone" autocomplete="on" placeholder="Telefon Numarası"></asp:TextBox>
                        </label>
                        <label>
                            <div class="fa fa-commenting"></div>
                            <asp:TextBox runat="server" ID="txtPsw" class="password" type="password" autocomplete="off" placeholder="Şifre"></asp:TextBox>
                        </label>
                        <div class="alert alert-danger" role="alert" runat="server" id="alert" style="display: none;">
                        ...
                        <asp:Button runat="server" ID="btnGiris" OnClick="btnLogin_Click" class="login-button" Text="Giriş"></asp:Button>
                    </div>
                </div>
            </div>
        </div>
