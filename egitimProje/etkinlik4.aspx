<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="etkinlik4.aspx.cs" Inherits="etkinlik4" %>
                        ...
                        <div class="wizard-forms position-relative">
                            ...
                            <div class="wizard-inner-box">
                                <div class="inner-title text-center">
                                    <p>
                                        Başla butonuna bastığında üç kelime grubu ile karşılaşacaksın. Her gruptan üç kelime seçerek bir metin yazabilir misin?
                                    </p>
                                    <p>Önemli olan en kısa sürede doğru bir metin yazmak</p>
                                    <br />
                        ...
                        <div class="wizard-forms form-step-2">
                            ...
                            <div class="wizard-inner-box">
                                <div class="inner-title text-center">
                                    ...
                                    <h3>En kısa sürede görmüş olduğun 3 kutucuktan kelimeleri toplayarak bir metin yaz!</h3>
                                </div>
                            </div>
                            <div class="details-form-area">
                                ...
                                <div class="row">
                                    <div class="textBox" style="width: 100%; padding: 50px;">
                                        <asp:TextBox TextMode="MultiLine" Rows="15" runat="server" ID="txt" Style="width: 100%;"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="actions">
