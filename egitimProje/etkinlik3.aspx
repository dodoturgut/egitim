<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="etkinlik3.aspx.cs" Inherits="etkinlik3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="wizard-forms position-relative">
                            ...
                            <div class="wizard-inner-box">
                                <div class="inner-title text-center">
                                    <p>Aşağıda ev kiralam ile ilgili on kelime var. Bu kelimeler sırayla gelecek. Bu kelimeleri kullanrak bir konuşma yapabilir misin?</p>
                                    <br />
                            ...
                            <div class="details-form-area">
                                <div class="row">
                                    <div class="col-md-12 col-lg-12 col-sm-12">
                                        <div class="soruBox">
                                            <h2>
                                                <asp:Label runat="server" ID="lblKelime"></asp:Label></h2>
                                        </div>
                                    </div>
                                </div>
                                <br />
    ...
    <script type="text/javascript">
        function kelimeGetir() {
            var lblKelime = document.getElementById("ContentPlaceHolder1_lblKelime");
            PageMethods.testaaa(
                function (result) {
                    lblKelime.innerText = result;
                }
            );
        }
