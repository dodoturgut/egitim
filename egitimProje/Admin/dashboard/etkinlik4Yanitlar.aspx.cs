...
public partial class Admin_dashboard_etkinlik4Yanitlar : System.Web.UI.Page
{
    ...
    private void tabelDoldur()
    {
        ...
        {
            baglanti.Open();
            MySqlCommand komut = new MySqlCommand("SELECT * FROM answers4", baglanti);
    ...
    protected void rptAnswers_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        MySqlCommand verisil = new MySqlCommand("delete from answers4 where userId = '" + e.CommandArgument + "'", baglanti);
        verisil.ExecuteNonQuery();

        string kayit = "update cevapstats set etkinlik4='false' where ogrenciID = '" + e.CommandArgument + "'";
