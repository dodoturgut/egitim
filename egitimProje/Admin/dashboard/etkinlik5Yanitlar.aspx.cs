...
public partial class Admin_dashboard_etkinlik5Yanitlar : System.Web.UI.Page
{
    ...
    private void tabelDoldur()
    {
        ...
        {
            baglanti.Open();
            MySqlCommand komut = new MySqlCommand("SELECT * FROM answers5", baglanti);
    ...
    protected void rptAnswers_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        MySqlCommand verisil = new MySqlCommand("delete from answers5 where userId = '" + e.CommandArgument + "'", baglanti);
        verisil.ExecuteNonQuery();

        string kayit = "update cevapstats set etkinlik5='false' where ogrenciID = '" + e.CommandArgument + "'";
