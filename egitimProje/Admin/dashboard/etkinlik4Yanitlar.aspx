<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true" CodeFile="etkinlik4Yanitlar.aspx.cs" Inherits="Admin_dashboard_etkinlik4Yanitlar" %>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Etkinlik 4 Yanıtları</h4>
                            </div>
                        </div>
                        <div class="card-body">
