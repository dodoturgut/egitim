...
public partial class Admin_dashboard_etkinlik2Yanitlar : System.Web.UI.Page
{
    ...
    protected void rptAnswers_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        MySqlCommand verisil = new MySqlCommand("delete from answers2 where userId = '" + e.CommandArgument + "'", baglanti);
        verisil.ExecuteNonQuery();

        string kayit = "update cevapstats set etkinlik2='false' where ogrenciID = '" + e.CommandArgument + "'";
