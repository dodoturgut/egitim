<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true" CodeFile="etkinlik5Yanitlar.aspx.cs" Inherits="Admin_dashboard_etkinlik5Yanitlar" %>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Etkinlik 5 Yanıtları</h4>
                            </div>
                        </div>
                        <div class="card-body">
